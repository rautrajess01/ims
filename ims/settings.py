...
MIDDLEWARE = [
    ...
    "core.middleware.JWTUserForHistoryMiddleware",
...
# Default: SQLite. For production set DB_ENGINE=postgres and DB_* below.
_db_engine = config("DB_ENGINE", default="sqlite").lower()
